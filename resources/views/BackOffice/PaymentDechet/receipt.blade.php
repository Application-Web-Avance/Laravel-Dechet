...
<table class="details" border="1" width="100%">
    ...
    <tr>
        <td><strong>Utilisateur Name</strong></td>
        <td>{{ $payment->utilisateur->name ?? 'Utilisateur non trouvé' }}</td>
    </tr>
     <tr>
            <td><strong>Utilisateur E-mail </strong></td>
            <td>{{ $payment->utilisateur->email ?? 'Email non trouvé' }}</td>
        </tr>
    <tr>
    ...
    <tr>
            <td><strong>Déscription de Déchet</strong></td>
            <td>{{ $payment->annonceDechet->description ?? 'Déscription non trouvée' }}</td>
        </tr>
    <tr>
