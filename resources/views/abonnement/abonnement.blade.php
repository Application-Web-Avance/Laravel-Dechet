                    ...
                    <div class="col-12 col-lg-12 col-xxl-9 d-flex">
                        <div class="card flex-fill">
                            <div class="card-header">
                                ...
                                <a href="{{ url('/abonnement/create') }}" type="button"
                                ...
                                <tbody>
                                    @foreach ($abonnement as $a)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('/abonnement/' . $a->id . '/edit') }}" type="submit" class="btn btn-link text-seccess"
                                                    style="text-decoration:none;" title="edit">
                                                    update
                                                </a>
                                                <!-- Delete form -->
                                                <form action="{{ url('/abonnement/' . $a->id) }}" method="POST"
