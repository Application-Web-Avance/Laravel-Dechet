        ...
        <div class="card-body p-5">
            ...
            <form action="{{ route('annoncedechets.update', $annoncedechet->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="mt-3" style="margin-left:500px;">

                     @if($annoncedechet->image)
                                                <img src="{{ asset('storage/' . $annoncedechet->image) }}" alt="Image de l'annonce" class="img-fluid" style="max-width: 300px; border-radius:20%">
                                            @else
